...
def _help_registry():
    ...
    return [
        ...
        {"command": "beacon milestone list", "flags": [], "description": "List milestones"},
        ...
        {"command": "beacon doc add <title>", "flags": ["--id <doc-id>", "--scope <core|spec|memo>", "--ms <id>", "--op <id>", "--trek <id>", "--content <text>", "--stdin", "--json"], "description": "Add a document"},
        ...
        {"command": "beacon stuck check", "flags": ["--telemetry-inline <json>", "--telemetry-file <path>", "--timeout-minutes N", "--dry-run", "--json"], "description": "Detect idle sessions; emit STUCK stop signals so morning briefing surfaces 介入要望"},
