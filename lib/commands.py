...
def _help_registry():
    ...
    return [
        ...
        {"command": "beacon doc add <title>", "flags": ["--id <doc-id>", "--scope <core|spec|memo>", "--ms <id>", "--content <text>", "--stdin"], "description": "Add a document"},
        ...
        {"command": "beacon stuck check", "flags": ["--telemetry-inline <json>"], "description": "Detect idle sessions; emit STUCK stop signals so morning briefing surfaces 介入要望"},
