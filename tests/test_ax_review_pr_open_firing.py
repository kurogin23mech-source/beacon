...
def test_pr_number_from_url_parses_github_pr():
    assert commands._pr_number_from_url("https://github.com/o/r/pull/477") == "477"
    assert commands._pr_number_from_url("https://github.com/o/r/pull/1?x=1") == "1"
    assert commands._pr_number_from_url("") == ""
    assert commands._pr_number_from_url("https://github.com/o/r/issues/5") == ""
