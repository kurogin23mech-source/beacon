...
```
未完了UC: UCn "<title>"
これを精査します。/beacon-review-uc を実行してください。
```
...
発見した X 件のタスクを俯瞰してクラスタリングし、マイルストーンへの再分割案を作成します。
/beacon-review-meta を実行してください。
```
...
```
メタレビュー完了済み。提案された MS 再分割案を適用します。
/beacon-review-apply を実行してください。
```
