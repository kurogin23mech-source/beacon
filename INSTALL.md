...
| **Linux** | Download `.AppImage` from [Releases](https://github.com/kurogin23mech-source/beacon/releases) and run `chmod +x Beacon-*.AppImage` | `pipx install beacon-ai`<br>or use Homebrew on Linux |
...
[Releases page](https://github.com/kurogin23mech-source/beacon/releases), open the disk image, and drag
...
[Releases page](https://github.com/kurogin23mech-source/beacon/releases) and double-click to install.
...
> - **Source:** `https://github.com/kurogin23mech-source/beacon/releases`
...
curl -LO https://github.com/kurogin23mech-source/beacon/releases/latest/download/Beacon-x86_64.AppImage
...
[Releases page](https://github.com/kurogin23mech-source/beacon/releases) — they are generated by the
...
The CLI tap lives at **`github.com/kurogin23mech-source/homebrew-beacon`**. After a new `v*` tag:

1. Get the source tarball SHA-256:

   ```bash
   curl -sL https://github.com/kurogin23mech-source/beacon/archive/refs/tags/v0.6.0.tar.gz | shasum -a 256
   ```
...
3. Copy the file into `Casks/beacon-desktop.rb` of `kurogin23mech-source/homebrew-beacon` and push.
